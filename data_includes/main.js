...
newTrial("feedback1",
    getVar("nblue")
        ...
        .success( newText("good", "Congratulations! You kept the outfit colors evenly balanced, so our guests were happy and the party was a success! Let’s hope we continue to do so well!").print() .css("font-size", "1.5em") .log())
        .failure( newText("bad", "Oh no! There were more guests wearing one outfit than the other! The guests weren’t happy! Let’s hope we can do better from now on!").print() .css("font-size", "1.5em") .log()  )
    ,
